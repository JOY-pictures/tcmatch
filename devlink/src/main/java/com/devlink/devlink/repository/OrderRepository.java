...
import com.devlink.devlink.model.Order;
import com.devlink.devlink.model.OrderStatus;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o FROM Order o WHERE o.deadline < CURRENT_TIMESTAMP AND o.status IN ('IN_PROGRESS', 'UNSER_REVIEW')")
